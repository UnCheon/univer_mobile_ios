...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event{
    NSLog(@"mk touch began");
    [self.superview.superview touchesBegan:touches withEvent:event];
    
}

- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    NSLog(@"mk touch ended");
    [self.superview.superview touchesEnded:touches withEvent:event];
    
}

- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
        NSLog(@"mk touch moved");
    [self.superview touchesMoved:touches withEvent:event];
    
}

- (void)touchesCancelled:(NSSet *)touches withEvent:(UIEvent *)event{
        NSLog(@"mk touch canceled");
...
{	
	...
	self.shine = YES;
	self.alignment = UITextAlignmentRight;
